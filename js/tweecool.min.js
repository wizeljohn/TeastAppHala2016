	...
	$.fn.extend({
		...
		tweecool : function(options) {
			...
			return this.each(function() {
				var o = options;
				var wrapper = $(this);
				var wInner = $('<ul class="list-group">').appendTo(wrapper);
				...
				$.getJSON("https://www.api.tweecool.com/?screenname=" + o.username + "&count=" + o.limit, function(data) {
					...
					$.each(data.tweets, function(i, field) {
						...
						wInner.append('<li class="list-group-item">' + pIMG + '<div class="tweets_txt">' + field.text.replace(urlpattern, '<a href="$1" target="_blank">$1</a>') + media + ' <span>' + timestamp + '</span></div></li>');
					});
